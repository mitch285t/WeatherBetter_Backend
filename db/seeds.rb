...
austin = Location.create(name: "Austin", latitude: 30.2711, longitude: -97.7403, current_weather_url: "https://api.weather.gov/stations/kaus/observations/latest", forecast_url: "https://api.weather.gov/gridpoints/EWX/155,90/forecast")
...
ana = User.create(username: "ananari", email: "ana@ana.com")
mitch = User.create(username: "mitch285t", email: "mitch@mitch.com")